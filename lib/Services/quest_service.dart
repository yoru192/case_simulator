...
class QuestService {
  ...
  static Future<void> _createAchievements(String userId) async {
    ...
    final achievements = [
      ...
      QuestModel(
        id: 'achievement_25_cases_${userId}',
        title: '📦 Початківець',
        description: 'Відкрий 25 кейсів',
        type: QuestType.achievement,
        requiredProgress: 25,
        moneyReward: 35.0,
        xpReward: 25,
      ...
      QuestModel(
        id: 'achievement_500_cases_${userId}',
        title: '🎰 Професіонал',
        description: 'Відкрий 500 кейсів',
        type: QuestType.achievement,
      ...
      QuestModel(
        id: 'achievement_1000_cases_${userId}',
        title: '👑 Магістр Кейсів',
        description: 'Відкрий 1000 кейсів',
        type: QuestType.achievement,
      ...
      QuestModel(
        id: 'achievement_1_classified_${userId}',
        title: '💫 Рожевий Дебют',
        description: 'Отримай Classified (рожевих) скін',
        type: QuestType.achievement,
        requiredProgress: 1,
        moneyReward: 30.0,
        xpReward: 50,
        userId: userId,
        trackingKey: 'classified_dropped',
      ),
      QuestModel(
        id: 'achievement_10_classified_${userId}',
        title: '💜 Рожевий Дрім',
        description: 'Відкрий 10 Classified (рожевих) скінів',
        type: QuestType.achievement,
        requiredProgress: 10,
        moneyReward: 250.0,
        xpReward: 120,
      ...
      QuestModel(
        id: 'achievement_5_covert_${userId}',
        title: '🔥 Коллекціонер Червоних',
        description: 'Відкрий 5 Covert (червоних) скінів',
        type: QuestType.achievement,
        requiredProgress: 5,
        moneyReward: 400.0,
        xpReward: 200,
      ...
      QuestModel(
        id: 'achievement_1k_earned_${userId}',
        title: '💵 Перші Гроші',
        description: 'Зароби \$1,000 від продажу',
        type: QuestType.achievement,
        requiredProgress: 1000,
        moneyReward: 100.0,
        xpReward: 55,
      ...
      QuestModel(
        ...
        title: '💰 Торговець',
        description: 'Зароби \$2,000 від продажу скінів',
        type: QuestType.achievement,
      ...
      QuestModel(
        id: 'achievement_25_sold_${userId}',
        title: '🌟 Початківець Ринку',
        description: 'Продай 25 предметів',
        type: QuestType.achievement,
        requiredProgress: 25,
        moneyReward: 30.0,
        xpReward: 20,
      ...
      QuestModel(
        id: 'achievement_100_sold_${userId}',
        title: '🤝 Активний Продавець',
        description: 'Продай 100 предметів',
        type: QuestType.achievement,
        requiredProgress: 100,
        moneyReward: 100.0,
        xpReward: 50,
      ...
      QuestModel(
        id: 'achievement_500_sold_${userId}',
        title: '📈 Торгова Акула',
        description: 'Продай 500 предметів',
        type: QuestType.achievement,
        requiredProgress: 500,
        moneyReward: 500.0,
        xpReward: 250,
